<p>{__('soneritics_buckaroo_afterpay_header')}</p>

<div class="ty-control-group">
    <label for="afterpay_date_of_birth" class="ty-control-group__title cm-required">{__('soneritics_buckaroo_gender')}</label>
    <select name="payment_info[gender]">
        <option value="1"{if $cart.payment_info.gender==1} selected="selected"{/if}>{__('soneritics_buckaroo_male')}</option>
        <option value="2"{if $cart.payment_info.gender==2} selected="selected"{/if}>{__('soneritics_buckaroo_female')}</option>
    </select>
</div>

<div class="ty-control-group">
    <label for="afterpay_date_of_birth" class="ty-control-group__title cm-required">{__('soneritics_buckaroo_dob')}</label>
...
{if strlen($cart.user_data.b_phone) > 0}
    <div class="ty-control-group">
        <label for="afterpay_phone_number" class="ty-control-group__title cm-required">{__('soneritics_buckaroo_mobile')}</label>
...
<div class="ty-control-group" style="display:none;">
    <label for="afterpay_house_number" class="ty-control-group__title cm-required">{__('soneritics_buckaroo_housenr')}</label>
...
<div class="ty-control-group">
    <label for="afterpay_accept_terms" class="ty-control-group__title cm-required">{__('soneritics_buckaroo_afterpay_terms_head')}</label>
    <p>{__('soneritics_buckaroo_afterpay_terms_body')}</p>
    <input for="afterpay_accept_terms" type="checkbox" name="payment_info[accepted_terms]" class="ty-input-checkbox" /> {__('soneritics_buckaroo_afterpay_terms_accept')}
</div>
